            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="hidden md:flex items-center gap-2">
                <div className="relative">
                  ...
                  <input placeholder="Search scans…" className="rounded-xl bg-white/5 pl-8 pr-3 py-2 text-sm border border-white/10 outline-none focus:border-sky-400/40" />
                </div>
                <a href="/history" className="rounded-xl px-3 py-2 text-sm bg-white/5 border border-white/10 hover:bg-white/10">History</a>
                <a href="/settings" className="rounded-xl px-3 py-2 text-sm bg-sky-500/20 border border-sky-400/30 hover:bg-sky-500/30">Settings</a>
              </div>
            </div>
