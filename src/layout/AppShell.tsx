  ...
  return (
    <div className='min-h-dvh relative overflow-x-hidden text-slate-100 bg-gradient-to-b from-slate-950 via-slate-950 to-slate-900'>
      <div className='grid grid-cols-1 md:grid-cols-[260px_1fr]'>
        ...
        <main className='h-dvh isolate flex flex-col overflow-y-auto overscroll-contain'>
          ...
          <header className='md:hidden sticky top-0 z-30 flex items-center justify-between bg-slate-900/85 backdrop-blur px-4 py-3 border-b border-white/10'>
            ...
            <button
              onClick={() =>
                alert('Install from the (+) icon in the address bar')
              }
          ...
          <div className='md:sticky md:top-0 z-20 bg-gradient-to-b from-slate-950/95 to-slate-950/80 backdrop-blur border-b border-white/10'>
            <div className='mx-auto max-w-[1400px] px-6 py-4'>
              <div className='flex items-center justify-between gap-4'>
                ...
                <div className='hidden md:flex items-center gap-2'>
                  ...
                  <NavLink
                    to='/settings'
                    className='rounded-xl px-3 py-2 text-sm bg-sky-500/20 border border-sky-400/30 hover:bg-sky-500/30'
                  >
                    Settings
                  </NavLink>
                </div>
